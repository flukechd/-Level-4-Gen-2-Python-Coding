...
for i in range(4):
    ...
    if i == 0:
        ...
        mask = cv2.circle(blank.copy(), (310, 210), 220, 255, -1)
        # cv2.imshow('c',circle)
...
# Add black borders between the images
result = cv2.copyMakeBorder(result, 40, 40, 40, 40, cv2.BORDER_CONSTANT, value=(0, 0, 0))
